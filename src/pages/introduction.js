...
このサイトは、なにも知らずに飲み続けている日本人730万人のベンゾジアゼピン系薬服用者の方のために、わたしの実体験にもとづいて作りました。まずはじめに強調しておきたいのは、よく知ればさほど怖いことにはなりません。<span className={Style.fontCrimson}>服薬していても絶対にすぐやめないように！</span>
      ...
      <Jumbotron>
      <p>【最大薬害？】<br />
      これを薬害と呼ぶのか医療スキャンダルと呼ぶのかわかりませんが日本における他の薬害被害と比べてみます。<br />
      ー被害者数比較ー<br />
      薬害エイズ：1800人<br />
      薬害肝炎：推定10,000人以上<br />
      ...
      <p>器質的な異常が見つからないとどの医師も「安定剤（抗不安薬）を出しておこう」というわけです（また日本は睡眠不足大国でもあります）。
        ...
        ただしメイラックス（ロフラゼプ酸）など半減期が超長期のベンゾには注意で、それらについてはすべてのケースで数年の漸減が必要と思った方が良いでしょう。半減期が長いので、離脱症状の発生に大きな遅延が生じる可能性があるためです）<br />
        <br />
        ※&nbsp;<strong>主治医のいうとおりのペース例&nbsp;</strong>＝ 「半分に割って数週，さらに4分の1で数週、そして0に」「減薬期間は約3か月で」など。
        <p><br />
        離脱症状が出た場合でも短期間で終わる可能性はそれなりにあります。しかし、自分は大丈夫だろうと甘くみないように。<span className={Style.fontCrimson}>ベンゾの場合は数ヶ月での断薬は一気断薬と同じ</span>と思ってください（重度身体依存の場合）。
      ...
      <p>ただアシュトンマニュアルをすでに読んだ方はわかると思いますが、アシュトンマニュアルの参考減薬ペース（半年）でもまだ速すぎるのです（重度身体依存の場合）。
        また細かい間違いもいくつかあります。 
        アシュトンマニュアルを読んだら次に<Link to="../doctors-article/26" target="blank" rel="noreferrer noopener">ベンゾジアゼピンテーパリング戦略とソリューション</Link>を読んでください。
