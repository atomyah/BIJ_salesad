...
const IndexPage = ({ data }) => (
  <Layout>
    ...
    <Container fluid="md">
              ...
              <Row>
                <Col>
                  ...
                  <span className={Style.fontSmall}>
                    米国のオンラインコミュニティ『<a href="http://www.benzobuddies.org/forum/index.php" target="blank" rel="noreferrer noopener">ベンゾバディ</a>』を参考に開発しました。
                    ※『<a href="http://www.benzobuddies.org/forum/index.php" target="blank" rel="noreferrer noopener">ベンゾバディ</a>』
                    については<a href="https://benzoinfojapan.org/medias-article/7" target="_blank" rel="noreferrer noopener">キャサリン・ピットマン博士の講演</a>をお読みください。
                  </span>
                  <br />
                  {/*
                  <a href="https://benzofaq.com/" target="blank" rel="noreferrer noopener">
            ...
            <Col>
              ...
              <Row>
                <Col>
                  ...
                  <span className={Style.fontSmall}>をマイナーアップデートしました。</span>
                  <span className={Style.fontSmall}>
      ...
      <br />
      <br />
      しかしベンゾジアゼピン薬はそのオールマイティな効能もあり、半世紀にわたり<Link to="introduction" target="_blank" rel="noreferrer noopener">不眠や不安だけでなく
      ...
      <br />
      そして、<span className={Style.fontCrimson}>日本だけの問題ではなく</span>、ほぼ<Link to="introduction" target="_blank" rel="noreferrer noopener">世界中で同じように起きている薬害問題</Link>です。
      <br />
      <br />
      <br />
      <br />
